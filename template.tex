...
Un logiciel a été conçu pour faire une mise en correspondance d'un arbre Minuit\footnote{Minuit~\cite{de2011jamoma} est un protocole de communication basé sur OSC permettant la découverte via réseau des paramètres contrôlables d'un logiciel multimédia.} vers le port série.

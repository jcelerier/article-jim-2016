...
C'est dû à la nécessité de composer en ayant conscience à chaque instant des fortes contraintes techniques du moyen de restitution de l'\oe uvre. 
...
\begin{figure}[h]
    ...
    \caption{Processus spatial durant l'exécution. $c$ a augmenté, et la zone triangulaire est mise à jour en conséquence. Il est possible de récupérer l'information de collision entre le disque et la zone pour déclencher des évènements ailleurs dans i-score.}
    \label{fig.space2}
\end{figure}

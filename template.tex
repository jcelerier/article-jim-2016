...
%      \small Blue Yeti, F-17110 France  \\
%      \small jcelerie@labri.fr  }
%  {Myriam Desainte-Catherine} {
%      \small Univ. Bordeaux, LaBRI, UMR 5800, F-33400 Talence, France.\\
%      \small CNRS, LaBRI, UMR 5800, F-33400 Talence, France.\\
%      \small INRIA, F-33400 Talence, France.\\
%      \small  myriam@labri.fr}
%  {Jean-Michel Couturier} {
%      \small Blue Yeti, F-17110 France.\\
%      \small jmc@blueyeti.fr}

\begin{document}
    
   % \author[1,2,3]{Jaime Arias\thanks{Electronic address: \texttt{jaime.arias@inria.fr}; Corresponding author}}
   % \author[1,2,4]{Jean-Micha\"el Celerier}
   % \author[1,2,3]{Myriam Desainte-Catherine}
    
    
   % \affil[1]{Univ. Bordeaux, LaBRI, UMR 5800, F-33400 Talence, France.}
   % \affil[2]{CNRS, LaBRI, UMR 5800, F-33400 Talence, France.}
   % \affil[3]{INRIA, F-33400 Talence, France.}
   % \affil[4]{Blue Yeti, F-17110 France.}
   {\tiny \maketitle}
%\footnote{\label{affil1} Univ. Bordeaux, LaBRI, UMR 5800, F-33400 Talence, France.}
%\footnote{\label{affil2}CNRS, LaBRI, UMR 5800, F-33400 Talence, France.}
%\footnote{\label{affil3}INRIA, F-33400 Talence, France.}
%\footnote{\label{affil4}Blue Yeti, F-17110 France.}
...
\begin{figure}[h]
	...
	\caption{Un scénario de type Sonopluie}
	\label{fig.sonopluie}
\end{figure}
...
Enfin, les performances ne sont pas adaptées à des évolutions rapides en temps réel : c'est le cas de la géométrie dynamique.
cela peut marcher en dimension 1 et pour des fonctions avec un nombre relativement important de points à calculer, mais est lourd en ressources en dimension 2 et quasiment impensable sur un CPU en temps réel en dimension 3.
...
Une tentative d'implémentation pour les calculs génériques sur les zones a été réalisée à l'aide du CAS\footnote{Computer Algebra System, système de calcul formel en français, est un type de logiciel permettant de réaliser du calcul symbolique.} \textit{GiNaC}~\cite{bauer2002introduction}.
